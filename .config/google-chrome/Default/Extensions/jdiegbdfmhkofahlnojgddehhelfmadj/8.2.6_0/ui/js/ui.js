//  
// Copyright (c) Adblock Genius PRO - All rights reserved. 
//
...
/******************************************************************************/
	...
	var go = function(){
		...
		$("#feedback-button").click(function(ev){
			...
			gotoURL(ev, "https://chrome.google.com/webstore/detail/"+myid+"/reviews");
		});
		...
		$("#donate-button").click(function(ev){
			//sendReport(ev);
			gotoURL(ev, "http://paypal.me/djamolgroup");
		});
