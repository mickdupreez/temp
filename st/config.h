 ...
 */
static char *font = "MesloLGSDZ Nerd Font Mono:pixelsize=16:antialias=true:autohint=true";
static char *font2[] = { "MesloLGSDZ Nerd Font Mono:pixelsize=16:antialias=true:autohint=true" };
