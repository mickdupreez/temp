...
VOLUME_ICONS=( "%{F#a6e22e}%{F-} " "%{F#a6e22e}%{F#a6e22e}%{F-} " "%{F#a6e22e}%{F#a6e22e}%{F-} " )  # Volume icons array, from lower volume to higher
MUTED_ICON=" "  # Muted volume icon
MUTED_COLOR="%{F#6b6b6b}"  # Color when the audio is muted
DEFAULT_SINK_ICON="%{F#a6e22e}%{F-}  "  # The default sink icon if a custom one isn't found
CUSTOM_SINK_ICONS=( "%{F#a6e22e}%{F-}"  )  # Custom sink icons in index of sink order
